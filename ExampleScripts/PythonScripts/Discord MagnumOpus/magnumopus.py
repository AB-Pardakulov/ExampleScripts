...
messages_str  + " Use indicators in their name, join date, and especially messages. Just provide a number with simple explanation. This is for fun. Do not take it seriously."])
